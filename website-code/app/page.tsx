...
function Hero() {
  return (
    <section
      id="home"
      className="relative h-[1080px] overflow-hidden bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="absolute left-[977px] top-[190px] w-[737px]">
        <Image
          src={heroCardOneDefault}
          alt="Hero welcome card"
          className="h-[394px] w-[713px] rounded-[20px] object-contain"
          priority
        />
        <div className="mt-[22px] flex gap-[22px]">
          <Image
            ...
            className="h-[335px] w-[358px] rounded-[20px] object-contain"
            priority
          />
          <Image
            src={heroCardThree}
            alt="Unlimited Possibilities card"
            className="h-[335px] w-[357px] rounded-[20px] object-contain"
            priority
          />
        </div>
      </div>
