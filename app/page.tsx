...
import heroCardOneBg from "../assets/hero/02-hero-card-01-bg.png";
import heroMainVisual from "../assets/hero/02-hero-card-01-mian visual.png";
import heroCardTwoBg from "../assets/hero/02-hero-card-02-bg.png";
import heroCardThreeBg from "../assets/hero/02-hero-card-03-bg.png";
...
function Hero() {
  return (
    <section
      id="home"
      className="h-[1080px] bg-cover bg-center bg-no-repeat pt-[190px]"
        ...
        <div className="w-[737px]">
          ...
          >
            <div className="relative z-10 w-[340px] pl-[46px] pt-[54px]">
              <p className="text-[12px] font-semibold uppercase tracking-[0.16em] text-white/50">Hi, Welcome to</p>
              <h2 className="mt-3 text-[48px] font-bold leading-[1.08] tracking-[-0.025em]">My Digital Space.</h2>
              ...
              <span className="mt-8 inline-flex h-[42px] items-center rounded-full border border-white/15 px-[22px] text-[12px] font-semibold uppercase tracking-[0.08em] text-white">
                DIVE DEEPER
              </span>
            </div>
            <Image
              src={heroMainVisual}
              alt="Futuristic portfolio hero visual"
              className="absolute bottom-[-138px] right-[-8px] w-[455px] object-contain"
              priority
            />
          </article>
          <div className="mt-[22px] flex gap-[22px]">
            <article
              className="flex h-[335px] w-[358px] items-end overflow-hidden rounded-[20px] border border-white/10 bg-cover bg-center p-[38px] shadow-[0_4px_20px_rgba(0,0,0,0.2)]"
            ...
            <article
              className="flex h-[335px] w-[357px] items-end justify-end overflow-hidden rounded-[20px] border border-white/10 bg-cover bg-center p-[38px] text-right shadow-[0_4px_20px_rgba(0,0,0,0.2)]"
